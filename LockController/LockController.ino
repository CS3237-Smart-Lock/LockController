...
// Possible PWM GPIO pins on the ESP32-S2: 0(used by on-board
// button),1-17,18(used by on-board LED),19-21,26,33-42 Possible PWM GPIO pins
// on the ESP32-S3: 0(used by on-board button),1-21,35-45,47,48(used by on-board
// LED) Possible PWM GPIO pins on the ESP32-C3: 0(used by on-board
// button),1-7,8(used by on-board LED),9-10,18-21
